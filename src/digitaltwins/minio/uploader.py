...
class Uploader(object):
    def __init__(self):
        ...
        try:
            ...
            logger.info(f"Connected to MinIO at {self._endpoint}")
    ...
    def bucket_exists(self, bucket_name: str) -> bool:
        ...
        try:
            ...
            if error_code == '404':
                ...
                logger.warning(f"Bucket '{bucket_name}' exists, but you do not have permission to access it.")
    ...
    def upload_file(self, file_path: str, bucket_name: str, object_name: str = None, overwrite: bool = False) -> bool:
        ...
        if not overwrite:
            try:
                ...
                logger.warning(f"File '{object_name}' already exists in bucket '{bucket_name}'. Skipping upload.")
                return False
            except ClientError as e:
